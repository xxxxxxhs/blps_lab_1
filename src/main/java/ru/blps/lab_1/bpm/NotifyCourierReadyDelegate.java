...
@Component("notifyCourierReadyDelegate")
public class NotifyCourierReadyDelegate implements JavaDelegate {

    private final OrderRepository orderRepository;
    private final OrderNotifier orderNotifier;

    public NotifyCourierReadyDelegate(OrderRepository orderRepository, OrderNotifier orderNotifier) {
