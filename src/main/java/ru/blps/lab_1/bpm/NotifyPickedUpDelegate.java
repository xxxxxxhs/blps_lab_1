...
@Component("notifyPickedUpDelegate")
public class NotifyPickedUpDelegate implements JavaDelegate {

    private final OrderRepository orderRepository;
    private final OrderNotifier orderNotifier;

    public NotifyPickedUpDelegate(OrderRepository orderRepository, OrderNotifier orderNotifier) {
